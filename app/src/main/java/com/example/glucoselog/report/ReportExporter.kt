    ...
    fun exportMonthReport(
        ...
        pages.forEachIndexed { index, pageEntries ->
            ...
            pageEntries.forEach { entry ->
                ...
                canvas.drawText(entry.contextTag.replace("_", " ").lowercase().replaceFirstChar { it.uppercase() }, 340f, y.toFloat(), smallPaint)
                canvas.drawText(entry.cgmReading?.toString() ?: "N/A", 650f, y.toFloat(), bodyPaint)
